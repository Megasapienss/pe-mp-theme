<?php
/**
 * Template for displaying single providers with medical reviewer functionality enabled
 *
 * @package PE_MP_Theme
 */
...
get_header();
$h1 = get_the_title();
if (get_field('provider_credentials')) {
    $h1 .= ', ' . get_field('provider_credentials');
}
...
<?php while (have_posts()) : the_post(); ?>
    ...
    <article class="provider-single provider-single--practitioner container">
        ...
        <div class="provider-single__meta">
            ...
            <div class="provider-single__meta-item">
                ...
                $taxonomies = array('service-delivery-method');
        ...
        <div class="provider-single__inner">
            ...
            <div class="provider-single__content">
                ...
                <div class="provider-single__title-wrapper">
                    ...
                    <?php endif; ?>
                    <div class="column">
                        <h1 class="provider-single__title">
                            <?= $h1; ?>
                        </h1>
                        <?php if (get_field('subtitle')) : ?>
                            <p class="provider-single__excerpt"><?= get_field('subtitle'); ?></p>
                        <?php endif; ?>
                        <?php if (get_field('enable_reviewer_functionality')) : ?>
    ...
    <?php
    // Get articles reviewed by this provider for the complex mosaic
    $reviewed_posts = get_posts(array(
        'post_type' => 'post',
        'posts_per_page' => 6, // Limit to 6 for mosaic display
        'meta_query' => array(
            array(
                'key' => 'medical_review_section_medical_reviewer',
                'value' => get_the_ID(),
                'compare' => '=',
            ),
        ),
    ...
    if (!empty($reviewed_posts)) {
        get_template_part('template-parts/mosaics/complex', '', [
            'title' => 'Reviewed by ' . get_the_title(),
