  ...
  function initGallerySwiper() {
    ...
    function initializeSwiperInstances() {
      try {
        ...
        // Test navigation
        var nextButton = gallerySwiper.querySelector('.swiper-button-next');
        var prevButton = gallerySwiper.querySelector('.swiper-button-prev');
        ...
        // Test thumbnails
        var thumbnailSlides = galleryThumbs.querySelectorAll('.swiper-slide');
        ...
        thumbnailSlides.forEach(function (slide, index) {
          slide.addEventListener('click', function () {
            console.log("Thumbnail ".concat(index, " clicked"));
